...
E009 - 14.04.2010 - AB - YAML-Template
*/
...
// ... E009 - begin
//
if(substr(CURRENT_TEMPLATE,0,4) == "yaml") {
    ?>
    <!--[if lte IE 7]>
    <link href="<?php echo 'templates/'.CURRENT_TEMPLATE.'/'; ?>css/explorer/iehacks_3col_fixed.css" rel="stylesheet" type="text/css" />
    <![endif]-->
    <?php
}
//
