...
E001 - 13.10.2010 - AB - snet-Shop
E007 - 13.10.2010 - AB - PayPal
*/
...
class paypal {
	...
	function install() {
		...
		// ... new
		//
		xtc_db_query("insert into ".TABLE_CONFIGURATION." ( configuration_key, configuration_value,  configuration_group_id, sort_order, date_added) values ('MODULE_PAYMENT_PAYPAL_ID', 'info@stimme.net',  '6', '4', now())");
		//
		// ... E001 - end
		//
		...
		// ... new
		//
		xtc_db_query("insert into ".TABLE_CONFIGURATION." ( configuration_key, configuration_value,  configuration_group_id, sort_order, set_function, date_added) values ('MODULE_PAYMENT_PAYPAL_USE_CURL', 'False', '6', '9', 'xtc_cfg_select_option(array(\'True\', \'False\'), ', now())");
		//
		// ... E007 - end
		//
	}
