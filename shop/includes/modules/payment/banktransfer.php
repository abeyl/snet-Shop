...
E017 - 11.11.2010 - AB - Tabellenprefix
*/
...
/* -----------------------------------------------------------------------------------------
  ...
  class banktransfer {
    ...
    function after_process() {
        ...
        // ... new
        //
        xtc_db_query("INSERT INTO xtc_banktransfer (orders_id, banktransfer_blz, banktransfer_bankname, banktransfer_number, banktransfer_owner, banktransfer_status, banktransfer_prz) VALUES ('" . $insert_id . "', '" . $this->banktransfer_blz . "', '" . $this->banktransfer_bankname . "', '" . $this->banktransfer_number . "', '" . $this->banktransfer_owner ."', '" . $this->banktransfer_status ."', '" . $this->banktransfer_prz ."')");
        if ($_POST['banktransfer_fax'])
            xtc_db_query("UPDATE xtc_banktransfer SET banktransfer_fax = '" . $this->banktransfer_fax ."' WHERE orders_id = '" . $insert_id . "'");
        //
        // ... E017 - end
        //
    ...
    function install() {
      ...
      // ... new
      //
      xtc_db_query("CREATE TABLE IF NOT EXISTS xtc_banktransfer (orders_id int(11) NOT NULL default '0', banktransfer_owner varchar(64) default NULL, banktransfer_number varchar(24) default NULL, banktransfer_bankname varchar(255) default NULL, banktransfer_blz varchar(8) default NULL, banktransfer_status int(11) default NULL, banktransfer_prz char(2) default NULL, banktransfer_fax char(2) default NULL, KEY orders_id(orders_id))");
      //
      // ... E017 - end
      //
