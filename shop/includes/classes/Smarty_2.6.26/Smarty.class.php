 ...
 */
    ...
    function fetch($resource_name, $cache_id = null, $compile_id = null, $display = false)
    {
        ...
        if ($display) {
            ...
            error_reporting($_smarty_old_error_level);
			// Modified for xt:Commerce v3.0.4 SP2.1 (c)2009 by Hetfield - www.MerZ-IT-SerVice.de - BOF //
			if (file_exists('includes/local/configure.php')) {
    			if (isset($_smarty_results)) { return '<!-- Begin: '.$resource_name.' -->'.$_smarty_results.'<!-- End: '.$resource_name.' -->'; }
  			} else {
    			if (isset($_smarty_results)) { return $_smarty_results; }
  			} 
			// Modified for xt:Commerce v3.0.4 SP2.1 (c)2009 by Hetfield - www.MerZ-IT-SerVice.de - EOF //
        }
    }
