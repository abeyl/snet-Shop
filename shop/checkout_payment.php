...
if($_GET['error_message']) {
	switch($_GET['error_message']) {
		case 1:
			$_GET['error_message'] = html_entity_decode(ERROR_CONDITIONS_NOT_ACCEPTED,ENT_COMPAT,"UTF-8");
			break;
		case 2:
			$_GET['error_message'] = html_entity_decode(ERROR_NO_PAYMENT_MODULE_SELECTED,ENT_COMPAT,"UTF-8");
			break;
		default:
			$_GET['error_message'] = html_entity_decode($_GET['error_message'],ENT_COMPAT,"UTF-8");
			break;
	}
}
//
