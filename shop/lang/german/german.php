...
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', 'Ihre eingegebene E-Mail Adresse existiert bereits - bitte verwenden Sie eine andere.');
define('ENTRY_EMAIL_ADDRESS_TEXT', '*');
define('ENTRY_STREET_ADDRESS_ERROR', 'Ihre Stra&szlig;e/Nr. muss aus mindestens ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' Zeichen bestehen.');
//
// ... E002 - end
//
...
// ... new
//
define('ENTRY_CITY_ERROR', 'Ihr Ort muss aus mindestens ' . ENTRY_CITY_MIN_LENGTH . ' Zeichen bestehen.');
define('ENTRY_CITY_TEXT', '*');
define('ENTRY_STATE_ERROR', 'Ihr Bundesland muss aus mindestens ' . ENTRY_STATE_MIN_LENGTH . ' Zeichen bestehen.');
define('ENTRY_STATE_ERROR_SELECT', 'Bitte w&auml;hlen Sie Ihr Bundesland aus der Liste aus.');
define('ENTRY_STATE_TEXT', '*');
...
// ... new
//
define('ERROR_CONDITIONS_NOT_ACCEPTED', '* Sofern Sie unsere Allgemeinen Gesch&auml;ftsbedingungen und die Widerrufsbelehrung nicht akzeptieren, k&ouml;nnen wir Ihre Bestellung bedauerlicherweise nicht entgegennehmen!');
//
// ... E002 - end
//
...
//define('JS_TO_DATE_LESS_THAN_FROM_DATE', '* Das Datum(von) mu� gr��er oder gleich sein als das Datum (bis)\n');
...
define('JS_INVALID_KEYWORDS', '* Suchbegriff unzul&auml;ssig\n');
define('TEXT_LOGIN_ERROR', '<span style="color:#ff0000; font-weight:bold">FEHLER:</span> Keine &Uuml;bereinstimmung der eingebenen \'E-Mail Adresse\' und/oder dem \'Passwort\'.');
define('TEXT_NO_EMAIL_ADDRESS_FOUND', '<span style="color:#ff0000; font-weight:bold">ACHTUNG:</span> Die eingegebene E-Mail Adresse ist nicht registriert. Bitte &uuml;berpr&uuml;fen Sie Ihre Eingabe.');
define('TEXT_PASSWORD_SENT', 'Ein neues Passwort wurde per E-Mail versendet.');
//
// ... E002 - end
//
...
define('TEXT_EMAIL_SUBJECT','Ihre Newsletteranmeldung');
define('TEXT_CUSTOMER_GUEST','Gast');
define('TEXT_LINK_MAIL_SENDED','Ihre Anfrage nach einem neuen Passwort muss von Ihnen erst best&auml;tigt werden.<br />Deshalb wurde Ihnen vom System eine E-Mail mit einem Best&auml;tigungslink geschickt. Bitte klicken Sie nach dem Erhalt der E-Mail auf den Link um eine weitere E-Mail mit Ihrem neuen Anmelde-Passwort zu erhalten. Andernfalls wird Ihnen das neue Passwort nicht zugestellt und eingerichtet!');
...
define('HEADING_PASSWORD_FORGOTTEN','Passwort erneuern?');
define('TEXT_PASSWORD_FORGOTTEN','&Auml;ndern Sie Ihr Passwort in drei leichten Schritten.');
define('TEXT_EMAIL_PASSWORD_FORGOTTEN','Best&auml;tigung f&uuml;r Passwort&auml;nderung');
//
// ... E002 - end
//
...
// ... new
//
define('MAIN_MESSAGE', 'Sie haben sich dazu entschieden, einen Gutschein im Wert von %s an %s versenden, dessen E-Mail Adresse %s lautet.<br /><br />Folgender Text erscheint in Ihrer E-Mail:<br /><br />Hallo %s,<br /><br />Sie haben einen Gutschein &uuml;ber %s von %s erhalten.');
//
// ... E002 - end
//
...
// ... A002 - begin
//
define('TOO_LESS_QTY_CANT_CHECKOUT', 'Die mit ** markierten Artikel sind leider nicht in der von Ihnen gew&uuml;schten Anzahl erh&auml;ltlich.<br />Bitte beachten Sie die Mindestmengen und erh&ouml;hen Sie die Bestellmenge f&uuml;r die gekennzeichneten Artikel. Vielen Dank!');
define('TEXT_MIN_QTY_TOTAL', 'Gesamtpreis:');
define('TEXT_MIN_QTY_NOT_REACHED', 'Mindestmenge noch nicht erreicht!');
//
// ... A002 - end
//
?>