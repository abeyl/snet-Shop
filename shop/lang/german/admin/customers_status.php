...
//define('TEXT_INFO_CUSTOMERS_STATUS_BT_PERMISSION_INTRO', '<b>M&ouml;chten Sie erlauben, daß diese Kundengruppe per Bankeinzug bezahlen darf?</b>');
//define('TEXT_INFO_CUSTOMERS_STATUS_CC_PERMISSION_INTRO', '<b>M&ouml;chten Sie erlauben, daß diese Kundengruppe per Kreditkarte bezahlen darf?</b>');
//define('TEXT_INFO_CUSTOMERS_STATUS_COD_PERMISSION_INTRO', '<b>M&ouml;chten Sie erlauben, daß diese Kundengruppe per Nachnahme bezahlen darf?</b>');
...
//define('TEXT_INFO_CUSTOMERS_STATUS_DISCOUNT_PRICE_INTRO', 'Maximaler Rabatt auf Produkte (abhängig von Rabatt eingestellt bei Produkt).');
...
//
//define('TEXT_INFO_DELETE_INTRO', 'Sind Sie sicher, daß Sie diese Kundengruppe l&ouml;schen wollen?');
