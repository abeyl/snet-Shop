...
/* -----------------------------------------------------------------------------------------
  ...
  // ... new
  //
  define('MODULE_PAYMENT_BANKTRANSFER_TEXT_BANK_INFO', 'Bitte beachten Sie, dass das Lastschriftverfahren <strong>nur</strong> von einem <strong>deutschen Girokonto</strong> aus m&ouml;glich ist');
  //
  // ... E002 - end
  //
  ...
  // ... old
  //
  //define('MODULE_PAYMENT_BANKTRANSFER_DATABASE_BLZ_DESC', 'M&ouml;chten Sie die Datenbanksuche f&uuml;r die BLZ verwenden? Vergewissern Sie sich, daß der Table banktransfer_blz vorhanden und richtig eingerichtet ist!');
  //
  // ... new
  //
  define('MODULE_PAYMENT_BANKTRANSFER_DATABASE_BLZ_DESC', 'M&ouml;chten Sie die Datenbanksuche f&uuml;r die BLZ verwenden? Vergewissern Sie sich, dass die Tabelle banktransfer_blz vorhanden und richtig eingerichtet ist!');
  //
  // ... E002 - end
  //
  ...
  // ... new
  //
  define('MODULE_PAYMENT_BANKTRANSFER_ALLOWED_DESC', 'Geben Sie <strong>einzeln</strong> die Zonen an, welche f&uuml;r dieses Modul erlaubt sein sollen. (z.B. AT,DE - wenn leer, werden alle Zonen erlaubt)');
  //
  // ... E002 - end
  //
