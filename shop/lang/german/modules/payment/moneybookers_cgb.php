...
/* -----------------------------------------------------------------------------------------
  ...
  // ... old
  //
  //define('MODULE_PAYMENT_MONEYBOOKERS_CGB_CURRENCY_DESC', 'Die W&auml;hrung, in der der Zahlungsvorgang abgewickelt wird. Wenn Ihre gew&auml;hlte W&auml;hrung nicht bei Moneybookers verfügbar ist, wird diese W&auml;hrung ausgew&auml;hlt.');
  //
  // ... new
  //
