...
------------------------------------------------------------------------------*/
  ...
  // ... new
  //
  define('TEXT_CARD_NOT_ACZEPTED', 'Die Zahlung mit einer <strong>%s</strong> Karte ist nicht m&ouml;glich, bitte verwenden Sie eine andere Karte!<br />Folgende Karten werden von uns akzeptiert: ');
  //
  // ... E002 - end
  //
  ...
  // ... new
  //
  define('TEXT_CVV', '<table align="center" cellspacing="2" cellpadding="5" width="400"><tr><td><span class="tableHeading"><strong>Visa, Mastercard, Discover und andere mit 3-stelligem CVV-Code</strong></span></td></tr><tr><td><span class="boxText">F&uuml;r Ihre eigene Sicherheit ist die Angabe Ihres Sicherheitscodes verpflichtend. Die Sicherheitsnummer ist eine 3-stellige Nummer, die im Unterschriftsfeld auf der R&uuml;ckseite Ihrer Kreditkarte gedruckt ist. Sie erscheint nach den letzten vier Stellen Ihrer Kartennummer auf der rechten Seite.</span></td></tr><tr><td align="center"><img src="images/cv_card.gif" alt="" /></td></tr></table><hr /><table align="center" cellspacing="2" cellpadding="5" width="400"><tr><td><span class="main"><strong>American Express 4-stelliger CVV-Code</strong> </span></td></tr><tr><td><span class="boxText">F&uuml;r Ihre eigene Sicherheit ist die Angabe Ihres Sicherheitscodes verpflichtend. Der American Express Sicherheitscode ist eine 4-stellige Nummer auf Ihrer Kartenvorderseite. Sie erscheint nach den letzten vier Stellen Ihrer Kartennummer auf der rechten Seite.</span></td></tr><tr><td align="center"><img src="images/cv_amex_card.gif" alt="" /></td></tr></table>');
  //
  // ... E002 - end
  //
  ...
  // ... new
  //
  define('MODULE_PAYMENT_CC_ALLOWED_DESC', 'Geben Sie <strong>einzeln</strong> die Zonen an, welche f&uuml;r dieses Modul erlaubt sein sollen. (z.B. AT,DE - wenn leer, werden alle Zonen erlaubt)');
  //
  // ... E002 - end
  //
  ...
  define('MODULE_PAYMENT_CC_EMAIL_DESC', 'Wenn eine E-Mail Adresse angegeben worden ist, werden die mittleren Ziffern der Kreditkarten-Nummer an diese Adresse gesandt. (Die &auml;usseren Ziffern werden in der Datenbank gespeichert und die mittleren darin werden zensiert.');
  define('TEXT_CCVAL_ERROR_INVALID_DATE', 'Das &quot;G&uuml;ltig bis&quot; Datum ist ung&uuml;ltig. Bitte korrigieren Sie Ihre Angaben.');
  define('TEXT_CCVAL_ERROR_INVALID_NUMBER', 'Die &quot;Kreditkarten-Nummer&quot;, die Sie angegeben haben, ist ung&uuml;ltig. Bitte korrigieren Sie Ihre Angaben.');
  //
  // ... E002 - end
