 ...
 */
  ...
  // ... new
  //
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_TEXT_TITLE',  xtc_image(DIR_WS_IMAGES . 'icons/sofortueberweisung_icon.gif', 'Sofort&uuml;berweisung nach der Bestellung', '', '', ' align="middle"' ) . 'Sofort&uuml;berweisung nach der Bestellung');
  // Not Installed and Admin?
  if (!defined('MODULE_PAYMENT_SOFORTUEBERWEISUNG_STATUS') && function_exists('xtc_catalog_href_link')) {
    define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_TEXT_DESCRIPTION', '<div align="center"><a href=' . xtc_href_link('sofortueberweisung_install.php', 'install=sofortueberweisung', 'SSL') . '>' . xtc_image(DIR_WS_IMAGES . 'icons/sofortueberweisung_autoinstaller.gif', 'Autoinstaller (empfohlen)') . '</a><br /><strong>Sofort&uuml;berweisung nach der Bestellung</strong><br />W&auml;hrend des Zahlungsprozesses wird der Kunde &uuml;ber anpassbare Texte und Bilder &uuml;ber das Zahlungssystem informiert und sofort nach Abschluss des Bestellvorgangs zur Sofort&uuml;berweisung-Webseite geleitet. Die Bestellung wird immer in die Datenbank geschrieben, auch wenn der Kunde den Bezahlvorgang abbricht. Er kann dann alternativ mit einer &uuml;blichen &Uuml;berweisung zahlen, bzw. noch kontaktiert werden.</div>');
  } else {
  ...
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_STATUS_TITLE', 'Sofort&uuml;berweisung Vorkasse Modus aktivieren');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_STATUS_DESC', 'Bezahlung per Vorkasse mit integrierter Sofort&uuml;berweisung akzeptieren?');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_ZONE_TITLE', 'Zahlungszone');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_ZONE_DESC', 'Wenn eine Zone ausgew&auml;hlt ist, gilt die Zahlungsmethode nur f&uuml;r diese Zone.');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_ORDER_STATUS_ID_TITLE', 'Bestellstatus festlegen');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_ORDER_STATUS_ID_DESC', 'Bestellstatus nach Eingang Erfolgsbenachrichtigung');
  ...
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_SORT_ORDER_DESC', 'Reihenfolge der Anzeige. Kleinste Ziffer wird zuerst angezeigt.');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_KDNR_TITLE', 'Kundennummer');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_KDNR_DESC', 'Ihre Kundennummer bei der Sofort&uuml;berweisung');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_PROJEKT_TITLE', 'Projektnummer');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_PROJEKT_DESC', 'Die verantwortliche Projektnummer bei der Sofort&uuml;berweisung, zu der die Zahlung geh&ouml;rt');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_INPUT_PASSWORT_TITLE', 'Input-Passwort');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_INPUT_PASSWORT_DESC', 'Das Input-Passwort (unter &quot;Nicht &auml;nderbare Parameter / Input-Passwort&quot;)');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_BNA_PASSWORT_TITLE', 'Benachrichtungspasswort');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_BNA_PASSWORT_DESC', 'Das Benachrichtungspasswort (unter &quot;Benachrichtigungen / Passwort f&uuml;r Benachrichtigungen&quot;)<br />Variablenname f&uuml;r Passwort (Default: pw) und Variablenname f&uuml;r Text (Default: text) bitte die Standardwerte (pw und text) eintragen');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_REDIRECT_TITLE', 'Sofortige Weiterleitung');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_REDIRECT_DESC', 'Nach Abschluss der Bestellung Kunde sofort zu Sofort&uuml;berweisung weiterleiten');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_STORE_TRANSACTION_DETAILS_TITLE', 'Transaktiondetails speichern');
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_STORE_TRANSACTION_DETAILS_DESC', 'Transaktionsdetails bei Benachrichtigung in das Kommentarfeld speichern (zum debuggen, ist f&uuml;r Kunden via Konto sichtbar)');
  // checkout_payment Informationen via Bild
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_TEXT_DESCRIPTION_CHECKOUT_PAYMENT', '<div><a href="#" onclick="window.open(\'https://www.sofort-ueberweisung.de/paynetag/anbieter/download/informationen.html\', \'Popup\',\'toolbar=yes,status=no,menubar=no,scrollbars=yes,width=690,height=500\'); return false;"><img src="'.'templates/'.CURRENT_TEMPLATE.'/buttons/' . $_SESSION['language'].'/sofortueberweisung.gif" alt="Sofort&uuml;berweisung" /></a></div>');
  // checkout_payment Informationen via Text
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_TEXT_DESCRIPTION_CHECKOUT_CONFIRMATION', '<div>Sofort&uuml;berweisung ist der kostenlose, <a href="#" onclick="window.open(\'https://www.sofortueberweisung.de/cms/index.php?plink=tuev-zertifikat&alink=sicherheit&fs=&l=0\', \'Popup\',\'toolbar=yes,status=no,menubar=no,scrollbars=yes,width=690,height=500\'); return false;">T&Uuml;V-zertifizierte</a> Zahlungsdienst der Payment Network AG. Ihre Vorteile: keine zus&auml;tzliche Registrierung, automatische Abbuchung von Ihrem Online-Bankkonto, h&ouml;chste Sicherheitsstandards und sofortiger Versand von Lagerware. F&uuml;r die Bezahlung mit Sofort&uuml;berweisung ben&ouml;tigen Sie Ihre eBanking Zugangsdaten, d.h. Bankverbindung, Kontonummer, PIN und TAN. Mehr Informationen finden Sie hier: <a href="#" onclick="window.open(\'https://www.sofort-ueberweisung.de/paynetag/anbieter/download/informationen.html\', \'Popup\',\'toolbar=yes,status=no,menubar=no,scrollbars=yes,width=690,height=500\'); return false;">www.sofortueberweisung.de</a>.</div>');
  // im Verwendungszweck werden folgende Platzhalter ersetzt:
  // {{orderid}}  durch Bestellnummer (nicht bei directes bezahlen)
  // {{order_date}} durch Bestelldatum
  // {{customer_id}} durch Kundennummer der Datenbank
  ...
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_TEXT_V_ZWECK_1', 'Bestellung bei ' . STORE_NAME);  // max 27 Zeichen
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_TEXT_V_ZWECK_2', 'Nr: {{orderid}} Kd-Nr. {{customer_id}}'); // max 27 Zeichen
  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_TEXT_EMAIL_FOOTER', "Sollten Sie den Betrag nicht via Sofortueberweisung bezahlt haben, bitten wir Sie uns zu kontaktieren.  \n\nAdressat:\n" . STORE_NAME_ADDRESS . "\n\n" . 'Ihre Bestellung wird nicht versandt, bis wir das Geld erhalten haben!');

  define('MODULE_PAYMENT_SOFORTUEBERWEISUNG_TEXT_REDIRECT', 'Sie werden nun zu Sofortueberweisung.de weitergeleitet. Sollte dies nicht geschehen bitte den Button dr&uuml;cken');
  //
  // ... E002 - end
  //
?>