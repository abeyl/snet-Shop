...
// ... new
//
define('MODULE_SHIPPING_UPS_SORT_ORDER_TITLE' , 'Anzeigereihenfolge');
define('MODULE_SHIPPING_UPS_SORT_ORDER_DESC' , 'Reihenfolge der Anzeige. Kleinste Ziffer wird zuerst angezeigt.');
define('MODULE_SHIPPING_UPS_ALLOWED_TITLE' , 'Erlaubte Zonen');
define('MODULE_SHIPPING_UPS_ALLOWED_DESC' , 'Geben Sie <strong>einzeln</strong> die Zonen an, welche f&uuml;r dieses Modul erlaubt sein sollen. (z.B. AT,DE - wenn leer, werden alle Zonen erlaubt)');
//
// ... E002 - end
//
