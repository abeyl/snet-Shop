...
//define('MODULE_SHIPPING_TABLE_HANDLING_DESC' , 'Handling Geb&uuml;hr für diese Versandmethode');
...
//define('MODULE_SHIPPING_TABLE_ZONE_DESC' , 'Wenn eine Zone ausgew&auml;hlt ist, wird diese Versandmethode ausschliseslich f&uuml;r diese Zone angewendet');
...
// ... new
//
define('MODULE_SHIPPING_TABLE_ALLOWED_TITLE' , 'Erlaubte Zonen');
define('MODULE_SHIPPING_TABLE_ALLOWED_DESC' , 'Geben Sie <strong>einzeln</strong> die Zonen an, welche f&uuml;r dieses Modul erlaubt sein sollen. (z.B. AT,DE - wenn leer, werden alle Zonen erlaubt)');
define('MODULE_SHIPPING_TABLE_COST_TITLE' , 'Versandkosten');
define('MODULE_SHIPPING_TABLE_COST_DESC' , 'Die Versandkosten basieren auf Gesamtkosten oder Gesamtgewicht der bestellten Waren. Beispiel: 25:5.50,50:8.50,etc.. Bis 25 werden 5.50 verrechnet, dar&uuml;ber bis 50 werden 8.50 verrechnet, etc.');
define('MODULE_SHIPPING_TABLE_MODE_TITLE' , 'Versandkosten Methode');
define('MODULE_SHIPPING_TABLE_MODE_DESC' , 'Die Versandkosten basieren auf Gesamtkosten oder Gesamtgewicht der bestellten Waren.');
define('MODULE_SHIPPING_TABLE_HANDLING_TITLE' , 'Bearbeitungsgeb&uuml;hr');
define('MODULE_SHIPPING_TABLE_HANDLING_DESC' , 'Bearbeitungsgeb&uuml;hr f&uuml;r diese Versandmethode.');
define('MODULE_SHIPPING_TABLE_TAX_CLASS_TITLE' , 'Steuerklasse');
define('MODULE_SHIPPING_TABLE_TAX_CLASS_DESC' , 'Folgende Steuerklasse an Versandkosten anwenden.');
define('MODULE_SHIPPING_TABLE_ZONE_TITLE' , 'Versandzone');
...
define('MODULE_SHIPPING_TABLE_SORT_ORDER_DESC' , 'Reihenfolge der Anzeige. Kleinste Ziffer wird zuerst angezeigt.');
//
// ... E002 - end
//
?>
