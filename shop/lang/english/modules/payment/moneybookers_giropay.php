...
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_TEXT_DESCRIPTION', 'Giropay via Moneybookers');
...
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_PROCESSED_STATUS_ID_TITLE', 'Order status - Processed');
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_PROCESSED_STATUS_ID_DESC', '');

define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_PENDING_STATUS_ID_TITLE', 'Order status - Sheduled');
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_PENDING_STATUS_ID_DESC', '');

define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_CANCELED_STATUS_ID_TITLE', 'Order status - Canceled');
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_CANCELED_STATUS_ID_DESC', '');

define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_TMP_STATUS_ID_TITLE', 'Order status - Temp');
...
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_EMAILID_TITLE', 'Email Address');
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_EMAILID_DESC', 'Email address you have registered with Moneybookers. <font color="ff0000">* Required</font>');
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_PWD_TITLE', 'Moneybookers Secret Word');
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_PWD_DESC', 'The secret word can be found in your Moneybookers profile (this is not your password!)');
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_MERCHANTID_TITLE', 'Merchant ID');
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_MERCHANTID_DESC', 'Merchant ID of your Moneybookers account <font color="ff0000">* Required</font>');
...
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_CURRENCY_TITLE', 'Transaction Currency');
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_CURRENCY_DESC', 'If the user\'s currency that is not available at Moneybookers this currency will be used for the payment.');
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_LANGUAGE_TITLE', 'Transaction Language');
define('MODULE_PAYMENT_MONEYBOOKERS_GIROPAY_LANGUAGE_DESC', 'If the user\'s language is not available at Moneybookers this language will be used for the payment.');
