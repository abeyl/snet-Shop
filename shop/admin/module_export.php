...
B013 - 14.07.2010 - AB - File-Module
A003 - 14.07.2010 - AB - Imageprocessing
E012 - 14.07.2010 - AB - XT-Module
*/
...
/* --------------------------------------------------------------
  ...
  switch ($_GET['action']) {
    ...
    if (count($_POST['configuration'])) {
      ...
      // ... new
      //
      if($class == 'image_processing_step' || $class == 'image_processing_new_step'){
      	$start = $_GET['start'];
    	if($start == '') {
       		$start = 0;
    	}
...
?>
			  ...
			  //
              //<tr>
              //  <td colspan="3" class="smallText">{php_open} echo TEXT_MODULE_DIRECTORY . ' admin/' . $module_directory; {php_close}</td>
              //</tr>
			  //
			  // ... E012 - end
			  //
