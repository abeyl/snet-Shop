...
?>
                ...
                // ... old
                //
                //<td class="dataTableContent">{php_open} if (eregi('^(.*)' . xtc_session_name() . '=[a-f,0-9]+[&]*(.*)', $whos_online['last_page_url'], $array)) { echo $array[1] . $array[2]; } else { echo $whos_online['last_page_url']; } {php_close}&nbsp;</td>
                //
                // ... new
                //
                ?>
