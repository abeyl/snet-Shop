...
/* --------------------------------------------------------------
  ...
  // ... old
  //
  //definde('TABLE_ADDRESS_BOOK', 'address_book');
  //definde('TABLE_ADDRESS_FORMAT', 'address_format');
  //definde('TABLE_ADMIN_ACCESS', 'admin_access');
  //definde('TABLE_BANNERS', 'banners');
  //definde('TABLE_BANNERS_HISTORY', 'banners_history');
  //definde('TABLE_CAMPAIGNS', 'campaigns');
  //definde('TABLE_CATEGORIES', 'categories');
  //definde('TABLE_CATEGORIES_DESCRIPTION', 'categories_description');
  //definde('TABLE_CONFIGURATION', 'configuration');
  //definde('TABLE_CONFIGURATION_GROUP', 'configuration_group');
  //definde('TABLE_TPL_MODULES_CONFIGURATION', 'tpl_modules_configuration ');
  //definde('TABLE_COUNTRIES', 'countries');
  //definde('TABLE_CURRENCIES', 'currencies');
  //definde('TABLE_CUSTOMERS', 'customers');
  //definde('TABLE_CUSTOMERS_BASKET', 'customers_basket');
  //definde('TABLE_CUSTOMERS_BASKET_ATTRIBUTES', 'customers_basket_attributes');
  //definde('TABLE_CUSTOMERS_INFO', 'customers_info');
  //definde('TABLE_CUSTOMERS_IP', 'customers_ip');
  //definde('TABLE_CUSTOMERS_STATUS', 'customers_status');
  //definde('TABLE_CUSTOMERS_STATUS_HISTORY', 'customers_status_history');
  //definde('TABLE_FORMS', 'forms');
  //definde('TABLE_LANGUAGES', 'languages');
  //definde('TABLE_MANUFACTURERS', 'manufacturers');
  //definde('TABLE_MANUFACTURERS_INFO', 'manufacturers_info');
  //definde('TABLE_NEWSLETTERS', 'newsletters');
  //definde('TABLE_NEWSLETTERS_HISTORY', 'newsletters_history');
  //definde('TABLE_NEWSLETTER_RECIPIENTS', 'newsletter_recipients');
  //definde('TABLE_ORDERS', 'orders');
  //definde('TABLE_ORDERS_PRODUCTS', 'orders_products');
  //definde('TABLE_ORDERS_PRODUCTS_ATTRIBUTES', 'orders_products_attributes');
  //definde('TABLE_ORDERS_PRODUCTS_DOWNLOAD', 'orders_products_download');
  //definde('TABLE_ORDERS_STATUS', 'orders_status');
  //definde('TABLE_ORDERS_STATUS_HISTORY', 'orders_status_history');
  //definde('TABLE_ORDERS_TOTAL', 'orders_total');
  //definde('TABLE_ORDERS_RECALCULATE', 'orders_recalculate');
  //definde('TABLE_PERSONAL_OFFERS_BY','personal_offers_by_customers_status_');
  //definde('TABLE_PRODUCTS', 'products');
  //definde('TABLE_PRODUCTS_ATTRIBUTES', 'products_attributes');
  //definde('TABLE_PRODUCTS_ATTRIBUTES_DOWNLOAD', 'products_attributes_download');
  //definde('TABLE_PRODUCTS_CONTENT','products_content');
  //definde('TABLE_PRODUCTS_DESCRIPTION', 'products_description');
  //definde('TABLE_PRODUCTS_NOTIFICATIONS', 'products_notifications');
  //definde('TABLE_PRODUCTS_IMAGES', 'products_images');
  //definde('TABLE_PRODUCTS_OPTIONS', 'products_options');
  //definde('TABLE_PRODUCTS_OPTIONS_VALUES', 'products_options_values');
  //definde('TABLE_PRODUCTS_OPTIONS_VALUES_TO_PRODUCTS_OPTIONS', 'products_options_values_to_products_options');
  //definde('TABLE_PRODUCTS_TO_CATEGORIES', 'products_to_categories');
  //definde('TABLE_PRODUCTS_VPE','products_vpe');
  //definde('TABLE_PRODUCTS_XSELL','products_xsell');
  //definde('TABLE_PRODUCTS_XSELL_GROUPS','products_xsell_grp_name');
  //definde('TABLE_REVIEWS', 'reviews');
  //definde('TABLE_REVIEWS_DESCRIPTION', 'reviews_description');
  //definde('TABLE_SESSIONS', 'sessions');
  //definde('TABLE_SPECIALS', 'specials');
  //definde('TABLE_TAX_CLASS', 'tax_class');
  //definde('TABLE_TAX_RATES', 'tax_rates');
  //definde('TABLE_TPL_MODULES_CONFIGURATION', 'tpl_modules_configuration');
  //definde('TABLE_GEO_ZONES', 'geo_zones');
  //definde('TABLE_ZONES_TO_GEO_ZONES', 'zones_to_geo_zones');
  //definde('TABLE_WHOS_ONLINE', 'whos_online');
  //definde('TABLE_ZONES', 'zones');
  //definde('TABLE_BOX_ALIGN','box_align');
  //definde('TABLE_CUSTOMERS_MEMO','customers_memo');
  //definde('TABLE_CONTENT_MANAGER','content_manager');
  //definde('TABLE_MEDIA_CONTENT','media_content');
  //definde('TABLE_MODULE_NEWSLETTER','module_newsletter');
  //definde('TABLE_CM_FILE_FLAGS', 'cm_file_flags');
  //definde('TABLE_COUPON_GV_QUEUE', 'coupon_gv_queue');
  //definde('TABLE_COUPON_GV_CUSTOMER', 'coupon_gv_customer');
  //definde('TABLE_COUPON_EMAIL_TRACK', 'coupon_email_track');
  //definde('TABLE_COUPON_REDEEM_TRACK', 'coupon_redeem_track');
  //definde('TABLE_COUPONS', 'coupons');
  //definde('TABLE_COUPONS_DESCRIPTION', 'coupons_description');
  //definde('TABLE_SERVER_TRACKING', 'server_tracking');
  //definde('TABLE_SHIPPING_STATUS', 'shipping_status');
  //definde('TABLE_BLACKLIST', 'card_blacklist');
  //definde('TABLE_CAMPAIGNS_IP','campaigns_ip');
  //
  // ... new
  //
  $prefix = "xtc_";
  ...
  define('TABLE_ADMIN_ACCESS', $prefix.'admin_access');
  ...
  define('TABLE_TPL_MODULES_CONFIGURATION', $prefix.'tpl_modules_configuration ');
  ...
  define('TABLE_FORMS', $prefix.'forms');
  ...
  define('TABLE_NEWSLETTERS', $prefix.'newsletters');
  define('TABLE_NEWSLETTERS_HISTORY', $prefix.'newsletters_history');
  ...
  define('TABLE_ORDERS_RECALCULATE', $prefix.'orders_recalculate');
  ...
  define('TABLE_BOX_ALIGN', $prefix.'box_align');
  define('TABLE_CUSTOMERS_MEMO', $prefix.'customers_memo');
  define('TABLE_CONTENT_MANAGER', $prefix.'content_manager');
  define('TABLE_MEDIA_CONTENT', $prefix.'media_content');
  define('TABLE_MODULE_NEWSLETTER', $prefix.'module_newsletter');
  define('TABLE_CM_FILE_FLAGS', $prefix.'cm_file_flags');
  ...
  define('TABLE_SERVER_TRACKING', $prefix.'server_tracking');
...
//  require(DIR_WS_FUNCTIONS . 'database.php');
  ...
  // ... new
  //
  if (defined('IMAGE_MANIPULATOR')) {
      define('FILENAME_IMAGEMANIPULATOR',IMAGE_MANIPULATOR);
  } else {
      define('FILENAME_IMAGEMANIPULATOR','image_manipulator_GD1.php');
  }
  //
  // ... B014 - end
  //
