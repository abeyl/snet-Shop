...
?>
    ...
    <tr>
        <td>
            <table border="0" cellspacing="0" cellpadding="2">
                    ...
                    <td colspan="2">
                        <table width="100%"  border="0">
                            ...
                            <tr>
                                ...
                                echo '<td><span class="main">'.xtc_draw_pull_down_menu('listing_template',$files,$default_value).'</span></td>';
                                ?>
                            </tr>
                            ...
                            <tr>
                                ...
                                echo '<td><span class="main">'.xtc_draw_pull_down_menu('categories_template',$files,$default_value).'</span></td>';
                                ?>
                            </tr>
                ...
                ?>
                <tr>
                    <td class="main"><?php echo TEXT_EDIT_TARGET_URL; ?></td>
                    <td class="main"><?php echo xtc_draw_input_field('target_url', $cInfo->target_url, 'size="100"'); ?></td>
                </tr>
    ...
    <tr>
        <td class="main" align="right">
            ...
            <?php echo "<input type=\"submit\" class=\"button\" name=\"update_category\" value=\"".BUTTON_SAVE."\" style=\"cursor:hand\" onClick=\"return confirm('".SAVE_ENTRY."')\">&nbsp;&nbsp;<a class=\"button\" onClick=\"this.blur()\" href=\"".xtc_href_link(FILENAME_CATEGORIES,"cPath=".$cPath."&cID=".$_GET['cID'])."\" />".BUTTON_CANCEL."</a>"; ?>
        </td>
        </form>
    </tr>