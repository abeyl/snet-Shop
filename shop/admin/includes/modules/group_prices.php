...
$group_query = xtc_db_query("SELECT customers_status_image, customers_status_id, customers_status_name
                                ...
                                WHERE language_id = '".$_SESSION['languages_id']."' AND customers_status_id != '0'");
		...
		if (PRICE_IS_BRUTTO == 'true') {
                ...
                <td style="border-top: 1px solid; border-color: #cccccc;" class="main">
                    ...
                    if ($_GET['pID'] != '') {
                        ...
                        ?>
                        <img onMouseOver="javascript:this.style.cursor='hand';" src="images/arrow_down.gif" height="12" width="12" onClick="javascript:toggleBox('staffel_<?php echo $group_data[$col]['STATUS_ID']; ?>');">
                        <?php
                    }

                    if ($_GET['pID'] != '') {
                        ?>
                        <div id="staffel_<?php echo $group_data[$col]['STATUS_ID']; ?>" class="longDescription">
                            <br />
                            <?php
                            ...
                            // ... old
                            //
                            //$staffel_query = xtc_db_query("SELECT products_id, quantity, personal_offer
