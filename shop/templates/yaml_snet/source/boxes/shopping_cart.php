...
if ($_SESSION['customers_status']['customers_status_show_price'] == '1') {
	...
	if (SHOW_SHIPPING=='true') {
			$box_smarty->assign('SHIPPING_INFO',' '.SHIPPING_EXCL.'<a class="popup shippingPop" href="'.xtc_href_link(FILENAME_POPUP_CONTENT,'coID='.SHIPPING_INFOS).'">'.SHIPPING_COSTS.'</a>');
	}
}
