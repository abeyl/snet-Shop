...
E004 - 10.03.2010 - AB - Datenschutzmassnahmen
*/
...
//
?>
<title>snet-Shop Installer - Welcome</title>
              ...
              <table width="300" border="0" cellpadding="0" cellspacing="4">
                <tr>
                  ...
                  <td width="192"><img src="images/icons/icon-deu.gif" width="30" height="16">
                    ...
                    // ... old
                    //
                    //{php_open} echo xtc_draw_radio_field_installer('LANGUAGE', 'german'); {php_close}
                    //
                    // ... new
                    //
                    echo xtc_draw_radio_field_installer('LANGUAGE', 'german', true);
                    //
                    // ... E002 - end
                    //
                    ?>
                ...
                //    {php_open} echo xtc_draw_radio_field_installer('LANGUAGE', 'english'); {php_close}
                //</tr>
                //
                // ... E002 - end
                //
