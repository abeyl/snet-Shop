...
//
?>
<title>snet-Shop Installer - STEP 4 / Webserver Configuration</title>
...
?>
            ...
            <form name="install" action="install_step5.php" method="post">
              ...
              // ... old
              //
              //<p><font size="1" face="Verdana, Arial, Helvetica, sans-serif">{php_open} echo xtc_draw_radio_field_installer('STORE_SESSIONS', 'files', true); {php_close} 
              //  <b>{php_open} echo TEXT_SESS_FILE; {php_close}</b><br />
              //  {php_open} echo xtc_draw_radio_field_installer('STORE_SESSIONS', 'mysql'); {php_close} 
              //
              // ... new
              //
              ?>
